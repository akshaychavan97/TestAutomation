...
public class TestCase_Creator {
		...
		public static void main(String[] args) throws Exception {
			xlRead("F:\\SLK\\TestCase_Creator\\TestCasesX.xls");
			Thread.sleep(2000);
			for (int i = 1; i < xlRows; i++) 
			{
				...
				int k=1;
				xData[k][1]="SetIT_Plan_Install_Regression_TC0";
				xData[k][2]="Desctiapation of TC with "+AttributeName+"";
				xData[k][3]="Step 1";
				xData[k][4]="Step Descipation";
				xData[k][5]="Expected Result";
				k=k+1;
				xData[k][1]="SetIT_Plan_Install_Regression_TC0";
				xData[k][2]="Desctiapation of TC with "+AttributeName+"";
				xData[k][3]="Step 1";
			...
			xlwrite("F:\\SLK\\TestCase_Creator\\NewTestCasesX.xls", xData);
